...
def check_hard_constraints(
    ...
    if (
        preferences.minimum_area_m2
        and listing.area_m2
        and listing.area_m2 < preferences.minimum_area_m2
    ):
        failures.append(f"Area {listing.area_m2}m² below minimum {preferences.minimum_area_m2}m²")
